...
Mock SCADA server for wind turbine energy simulation with Go & Python stack
...
Welcome to the **Energy Wind Turbine Scada Mock** repository. This project is built to deliver a robust and scalable solution tailored to modern development standards.
...
2. Navigate to the project directory:
   ```bash
   cd energy-wind-turbine-scada-mock
   ```
